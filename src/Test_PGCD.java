...
public class Test_PGCD {
        public static void main(String[] args) {
                ...
                // les affichages
                System.out.println("Entrée le 1er nombre : ");
                a = clavier.nextInt();
                int memoire_a = a;

                System.out.println("Entrée le 2nd nombre : ");
                b = clavier.nextInt();
                int memoire_b = b;
                ...
                System.out.println("le nombre b est maintenant : " + b);
                System.out.println("nombre de division par 2 de b : " + b_deux);
                System.out.println("nombre de division par 3 de b : " + b_trois);
                System.out.println("nombre de division par 5 de b : " + b_cinq);
                System.out.println("nombre de division par 7 de b : " + b_sept);
                System.out.println("nombre de division par 11 de b : " + b_onze);
                System.out.println("nombre de division par 13 de b : " + b_treize);
                ...
                // affichage du PGCD
                System.out.println("le PGCD de " + memoire_a + " et de " + memoire_b + " est de : " + PGCD);
